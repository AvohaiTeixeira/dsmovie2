...
//	MvcRequestMatcher scores = new MvcRequestMatcher( null, "/scores");
//	
//	@Bean
...
//						authorizeConfig.requestMatchers(scores).permitAll();
//						//authorizeConfig.requestMatchers(HttpMethod.PUT, "/scores").permitAll();
//											
